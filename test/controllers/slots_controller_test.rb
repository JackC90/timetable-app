...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { day: @slot.day, end_time: @slot.end_time, start_time: @slot.start_time, subject_id: @slot.subject_id } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { day: @slot.day, end_time: @slot.end_time, start_time: @slot.start_time, subject_id: @slot.subject_id } }
